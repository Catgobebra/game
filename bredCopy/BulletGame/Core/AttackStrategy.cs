...
{
    void Shoot(Vector2 position, IBulletPool OptimizedBulletPool, int bulletsPerShot, float bulletSpeed, bool isPlayerBullet);
}
...
public class StraightLineStrategy : IAttackStrategy
{
    ...
    public void Shoot(Vector2 position, IBulletPool OptimizedBulletPool, int bulletsPerShot, float bulletSpeed, bool isPlayerBullet)
    {
...
public class A_StraightLineStrategy : IAttackStrategy
{
    ...
    public A_StraightLineStrategy(IPlayer direction, Color color)
    {
...
public class RadiusBulletStrategy : IAttackStrategy
{
    ...
    public RadiusBulletStrategy(IPlayer target, Color color)
    {
        _target = target;
        _color = color;
    }

    public void Shoot(Vector2 shooterPosition, IBulletPool OptimizedBulletPool,
...
public class PlayerExplosiveShotStrategy : IAttackStrategy
{
    ...
    public void Shoot(Vector2 position, IBulletPool bulletPool,
                     int bulletsPerShot, float bulletSpeed, bool isPlayerBullet)
    {
...
public class StarPatternStrategy : IAttackStrategy
{
    ...
    public void Shoot(Vector2 position, IBulletPool pool,
...
public class CrystalFanStrategy : IAttackStrategy
{
    ...
    private void CreateFan(Vector2 pos, Vector2 baseDirection, IBulletPool pool,
...
public class FractalSquareStrategy : IAttackStrategy
{
    ...
    private void CreateSquareLayer(Vector2 center, IBulletPool pool,
...
public class PulsingQuantumStrategy : IAttackStrategy
{
    ...
    private void CreateQuantumRing(Vector2 center, IBulletPool pool,
    ...
    private void CreateCentralImpulse(Vector2 center, IBulletPool pool,
...
public class QuantumVortexStrategy : IAttackStrategy
{
    ...
    private void CreateRing(Vector2 center, float radius, int count, Color color,
                           IBulletPool pool, float speed, bool isPlayer)
    {
